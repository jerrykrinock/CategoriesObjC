...
- (NSString*)browserNameFromUserAgentStringAmongCandidates:(NSArray*)candidates {
	...
	// OmniWeb:   Mozilla/5.0 (Macintosh; U; Intel macOS 10_6_2; en-US) AppleWebKit/531.9+(KHTML, like Gecko, Safari/528.16) OmniWeb/v622.11.0
	// Opera:     Opera/9.80 (Macintosh; Intel macOS; U; en) Presto/2.2.15 Version/10.10
	// Firefox:   Mozilla/5.0 (Macintosh; U; Intel macOS 10.6; en-US; rv:1.9.1.7) Gecko/20091221 Firefox/3.5.7
	// Minefield: Mozilla/5.0 (Macintosh; U; Intel macOS 10.6; en-US; rv:1.9.3a2pre) Gecko/20100214 Minefield/3.7a2pre
	// Camino:    Mozilla/5.0 (Macintosh; U; Intel macOS 10.6; en; rv:1.9.0.16pre) Gecko/2009113000 Camino/2.1a1pre (like Firefox/3.0.16pre)
	// Safari:    Mozilla/5.0 (Macintosh; U; Intel macOS 10_6_2; en-us) AppleWebKit/531.21.8 (KHTML, like Gecko) Version/4.0.4 Safari/531.21.10
	// Chrome:    Mozilla/5.0 (Macintosh; U; Intel macOS 10_6_6; en-US) AppleWebKit/534.10 (KHTML, like Gecko) Chrome/8.0.552.237 Safari/534.10
